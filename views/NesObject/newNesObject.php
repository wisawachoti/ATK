...
<div class="box">
    <label class="New">  NEW NECESSARY OBJECT  </label>
    <div class="search">
        <label>  Necessary Object ID :  
            <input type="text" name="NESid" value="<?php echo "$ID"?>" placeholder="Necessary Object ID" required/>
        </label>
    </div>
    <div class="search">
        <label>  Necessary Object Quantity :  
            <input type="number" name="NESquantity" placeholder="Necessary Object Quantity" min="1" max="20" required/>
        </label>
    </div>
    <div class="db">
    ...
    <button class="btn2" type="submit" name="action" value="addNesObject"> ADD </button>
</form>