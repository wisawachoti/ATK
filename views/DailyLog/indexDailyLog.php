...
<table class= "content-table" border= 2>
    ...
    <tr>
        <td> DailyLog ID </td> 
        <td> DailyLog Date </td>  
        <td> DailyLog Colour </td> 
        <td> DailyLog Illness </td>
    ...
    <?php 
        foreach($dailyloglist as $dailylogas){
            echo "
                    ...
                    <td> <a href=?controller=DailyLog&action=updateForm&DLOGid=$dailylogas->DLOGid>
                         Update </a></td>
                    <td> <a href=?controller=DailyLog&action=DeleteConfirm&DLOGid=$dailylogas->DLOGid>
                         Delete </a></td>
                </tr>";
        }
        echo "</table>";
